...
if (isset($_POST['submit'])) {
  ...
  $cpassword=$_POST['cpassword'];
      ...
      $q="UPDATE `users` SET `password`='$password' WHERE `id`=$get_id";
      $r=mysqli_query($dbc,$q);
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                ?>
                  ...
                  <form class="user" action="forgot-password.php?id=<?= $get_id ?>" method="post">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="password" class="form-control form-control-user" placeholder="Répéter le mot de passe" name="cpassword">
                  </div>
                </div>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="update_emp.php?id=<?= $get_id ?>">Modifier un employé</a>
                  </div>
                  <div class="text-center">
                <a class="small" href="g_employes.php">Gestion des employés</a>
              </div>
              <div class="text-center">
