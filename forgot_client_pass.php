...
if (isset($_POST['submit'])) {
  ...
  $q="SELECT * FROM `client` WHERE `email`='$email' and `isEmailConfirmed`=1";
  ...
  if($num==1){
    ...
    $message="
      ...
      http://localhost/traineeship/update_client_fgpass.php?email=".$email."&token=".$token;
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                ?>
                  ...
                  <form class="user" action="forgot_client_pass.php" method="post">
                ...
                <a class="small" href="login_client.php">Vous avez déjà un compte? S'identifier!</a>
                  ...
                  <div class="text-center">
                    <a class="small" href="register_client.php">Créer un compte!</a>
                  </div>
                  <div class="text-center">
